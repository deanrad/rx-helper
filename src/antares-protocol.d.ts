...
export declare class Agent implements ActionProcessor {
  ...
  /**
   * Gets an Observable of all actions matching the ActionFilter. */
  eventsOfType(matcher: ActionFilter): Observable<Action>
  /**
   * Gets a promise for the next action matching the ActionFilter. */
  nextActionOfType(matcher: ActionFilter): Promise<Action>
  /**
   * Gets a promise for the next event matching the ActionFilter. */
  nextOfType(matcher: ActionFilter): Promise<Action>
 ...
 * @see randomId
 */
export declare const randomIdFilter: (
  length?: number,
  key?: string
) => ({ action }: ActionStreamItem) => void
/**
