...
result.completed.then(({ sleep }) => ).then(r => log(`Good night. ${sleep}`))
while each handler is available under their name: result.completed.sleep.then(...)
